...
public class JDEditText extends AppCompatEditText {


    public JDEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public JDEditText(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs);
    }

    public JDEditText(Context context) {
        super(context);
        init(null);
    }
